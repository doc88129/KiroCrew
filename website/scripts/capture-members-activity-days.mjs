/**
 * Capture the Crew Members detail panel (right column) on a REAL pod, for the
...
async function shoot(browser, theme, lang, suffix) {
  ...
  const panel = page.locator('div.border-l.border-border.h-full:has(#member-drawer)').last()
