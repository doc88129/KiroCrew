...
export type MemoryRecordQuery = { q: string; kind: MemoryRecordKind | 'all'; topic?: 'email' }
...
export type MemoryEditPreview = {
  ...
  entries: { before: MemoryRecord; after: MemoryRecord | null; operation?: 'resolve' | 'correct' | 'forget' }[]; preview_has_more: boolean; warnings: string[]
}
