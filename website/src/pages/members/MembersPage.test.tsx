...
describe('MembersPage drawer and edit jump', () => {
  ...
  it('the drawer folds the recorded activity by day, with the time strip behind each row, and honest counters', async () => {
    ...
    expect(today).toHaveTextContent('1 routed')
    ...
    expect(within(times).getByTitle(/routed to this member/i)).toBeTruthy()
