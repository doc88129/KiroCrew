...
[
  ...
  },
  {
    ...
    "description": "A separate reviewer session reviews your dashboard chat sessions as the agent works and flags issues. Off by default; override it per session in the model picker.",
    "tab": "chat",
    "type": "toggle",
    "occurrence": 1,
