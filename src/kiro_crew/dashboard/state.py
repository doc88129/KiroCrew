...
class _ChatSlot:
    ...
    def __init__(
        ...
        #: Bumped on every override write through the endpoint: a rollback or
        #: post-save rebind restore may undo only the transaction that captured it.
        self._advisor_override_txn: int = 0
