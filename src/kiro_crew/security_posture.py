...
_REDACTION_SINKS: tuple[tuple[str, str, str], ...] = (
    ...
    (
        ...
        "Reviewer output is model output over the observation the host hands "
        "it (the primary's transcript and tool results), so a credential echoed "
        "from that observation or an exfiltration URL would otherwise reach the "
        "primary provider and the transcript.",
    ),
    (
