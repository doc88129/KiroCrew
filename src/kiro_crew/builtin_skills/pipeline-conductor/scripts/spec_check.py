...
Exit codes:
    ...
    2   malformed spec — stderr names the field, the offending value, and the
        ...
        that gate cannot be enforced at all: an unenforceable precondition is a
        refusal here, never a plain read.
...
try:
    ...
    # reopen exactly the bypass the import exists to close, and it would do
