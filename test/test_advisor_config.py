...
def _fresh():
    ...
    # Probes answered yes on this host; the backend confirmation stays closed
    # until configure_from_config sees agent.acp_backend == kiro.
    service_mod._service.sandbox_available = True
    service_mod._service.read_gate_available = True
